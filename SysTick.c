...
//CLOCK SPEED HAS BEEN CHANGED TO ~14MHz
//SIKE ITS BACK TO 120MHZ RIGHT NOW
...
void SysTick_Wait10ms(uint32_t delay)
{
  ...
  for(i=0; i<delay; i++)
  {
    SysTick_Wait(140000); //wait 10ms (14MHz)
...
void SysTick_Wait1ms(uint32_t delay)
{
  ...
  for(i=0; i<delay; i++)
  {
    //SysTick_Wait(120000); //120MHz
    SysTick_Wait(14000); //wait 1ms (14MHz)
  }
}
